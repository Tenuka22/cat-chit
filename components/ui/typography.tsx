...
export const H1 = createComponent<HTMLHeadingElement>(
  "h1",
  "scroll-m-20 text-4xl font-normal tracking-tight lg:text-5xl",
  "H1",
);

export const H2 = createComponent<HTMLHeadingElement>(
  "h2",
  "scroll-m-20 border-b py-2 text-3xl font-light tracking-tight first:mt-0",
  "H2",
);
...
export const P = createComponent<HTMLParagraphElement>(
  "p",
  "leading-7 [&:not(:first-child)]:pt-sm",
  "P",
);
...
export const MultilineCode = createComponent<HTMLPreElement>(
  "pre",
  "relative rounded-sm bg-muted p-space-sm font-mono text-sm font-semibold overflow-x-auto",
  "MultilineCode",
);

export const List = createComponent<HTMLUListElement>(
  "ul",
  "py-space-sm ml-6 list-disc [&>li]:pt-space-sm",
  "List",
);

export const Quote = createComponent<HTMLQuoteElement>(
  "blockquote",
  "pt-space-sm border-l-2 pl-space-md italic text-muted-foreground",
  "Quote",
);
